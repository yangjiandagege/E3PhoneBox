export PJDIR := ${FORGE_ANDROID_ROOT}/vendor/forge/cubic/pjproject-2.4
...
# Android
ANDROID_CFLAGS = -DPJMEDIA_VIDEO_DEV_HAS_ANDROID_OPENGL=1 -DPJMEDIA_VIDEO_DEV_HAS_ANDROID=1
...
export APP_CC := ${FORGE_ANDROID_ROOT}/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.7/bin/arm-linux-androideabi-gcc
export APP_CXX := ${FORGE_ANDROID_ROOT}/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.7/bin/arm-linux-androideabi-g++
export APP_CFLAGS := -DPJ_AUTOCONF=1\
	-I${FORGE_ANDROID_ROOT}/prebuilts/ndk/9/platforms/android-18/arch-arm/usr/include -I${FORGE_ANDROID_ROOT}/prebuilts/ndk/9/sources/cxx-stl/gnu-libstdc++/4.7/include -I${FORGE_ANDROID_ROOT}/prebuilts/ndk/9/sources/cxx-stl/gnu-libstdc++/4.7/libs/armeabi/include -fexceptions -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1 -I${FORGE_ANDROID_ROOT}/vendor/forge/cubic/pjproject-2.4/openssl-include\
	$(PJ_VIDEO_CFLAGS) \
...
export APP_LDFLAGS := -L$(PJDIR)/pjlib/lib\
	...
	$(PJ_VIDEO_LDFLAGS) \
	-nostdlib -L${FORGE_ANDROID_ROOT}/prebuilts/ndk/9/platforms/android-18/arch-arm/usr/lib -L${FORGE_ANDROID_ROOT}/prebuilts/ndk/9/sources/cxx-stl/gnu-libstdc++/4.7/libs/armeabi -L${FORGE_ANDROID_ROOT}/vendor/forge/cubic/pjproject-2.4/openssl-lib
...
export APP_LDLIBS := $(PJSUA_LIB_LDLIB) \
	...
	$(APP_THIRD_PARTY_EXT)\
	$(PJLIB_LDLIB) \
	-lssl -lcrypto -ldl -lz -lm ${FORGE_ANDROID_ROOT}/prebuilts/ndk/9/platforms/android-18/arch-arm/usr/lib/crtbegin_so.o -lgnustl_static -lc -lgcc -lOpenSLES -llog -lGLESv2 -lEGL -landroid
...
export PJ_INSTALL_CFLAGS := -I$(PJ_INSTALL_INC_DIR) -DPJ_AUTOCONF=1	-I${FORGE_ANDROID_ROOT}/prebuilts/ndk/9/platforms/android-18/arch-arm/usr/include -I${FORGE_ANDROID_ROOT}/prebuilts/ndk/9/sources/cxx-stl/gnu-libstdc++/4.7/include -I${FORGE_ANDROID_ROOT}/prebuilts/ndk/9/sources/cxx-stl/gnu-libstdc++/4.7/libs/armeabi/include -fexceptions -DPJ_IS_BIG_ENDIAN=0 -DPJ_IS_LITTLE_ENDIAN=1 -I${FORGE_ANDROID_ROOT}/vendor/forge/cubic/pjproject-2.4/openssl-include
